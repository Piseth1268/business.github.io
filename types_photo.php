...
<?php  include("../crud/type_photo.php")?>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <label class="mt-2" for="">Type Photo</label>
                  <input class="form-control" type="file" name="txt_photo" id="">
     ...
     <table class="table table-bordered text-center   w-50 text-white" style="margin-left:320px; margin-top:10px;">
        <thead>
             <tr>
                <th>Id</th>
                <th>Photos</th>
        ...
        <tbody>
            <?php 
             ...
             $sql = "SELECT * FROM `tb_types_photo`";
            ...
            <tr>
                <td><?=$index?></td>
                <td><img src="../upload/<?=$row['photo']?>" width="50px" height="50px" style="border-radius:50px" alt=""></td>
                <td><?=$row['type']?></td>
                <td>
                    <button class="btn btn-success"  data-toggle="modal" data-target="#ModalUpdete-<?=$row['id']?>" type="submit" name="btn-update">Update</button>
                    <button class="btn btn-danger" data-toggle="modal" data-target="#ModalDelete-<?=$row['id']?>">Delete</button>
                </td>
            </tr>

            <!-- Modal Update -->
 <div class="modal fade" id="ModalUpdete-<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
      <form action="" method="post" enctype="multipart/form-data">
           <input type="text" name="txt_id" class="form-control" value="<?=$row['id']?>" id="">
           <div class="form-group">
 ...
 <div class="modal fade" id="ModalDelete-<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Do you want to delete? Type : <?=$row['type']?></p>
         <form action="" method="post" enctype="multipart/form-data">
             <input type="hidden" class="form-control" name="txt_id" value="<?=$row['id']?>">
