<?php 
  session_start();
  if(!($_SESSION['FullNmae']&& $_SESSION['Password'])){
        ...
        <div class="box-center">
            <div class="sub1">
                ...
                <div class="box1">
                    ...
                    <div class="right"><p><a class="a1" style="color: white;" href="../html/types_photo.php">Type photo</a></p></div>
                </div>
                <div class="box1">
                    <div class="left"><i class="fa-solid fa-file-arrow-up"></i></div>
                    <div class="right"><a class="a1" style="color: white;" href="../html/banner.php">Banner</a></div>
                </div>

                <div class="box1">
                    <div class="left"><i class="fa-solid fa-file-arrow-up"></i></div>
                    <div class="right"><a class="a1" style="color: white;" href="../html/new.php">New</a></div>
                </div>
                </div>
                ...
                <div class="box1">
                    ...
                    <div class="right"><a href="../admin2/logout.php"><p id="logout_sweet">Logout</p></a></div>
                </div>
            </div>
        </div>  
    </div>
...
<button type="button" class="btn  btn-outline-primary" style="margin-left:320px; margin-top:45px;" data-toggle="modal" data-target="#exampleModal">
  Create New
</button>
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                    ...
                    <input type="text" name="txt_title" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Date</label>
                    <input type="date" name="txt_date" class="form-control" id="">
               </div>
               ...
               <div class="form-group">
                    ...
                    <input type="text" name="txt_publisher" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Title_detail1</label>
                    <input type="text" name="txt_title_detail1" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Title_detail2</label>
                    <input type="text" name="txt_title_detail2" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_card</label>
                    <input type="file" name="txt_thumbnail_card" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail1</label>
                    <input type="file" name="txt_thumbnail_detail1" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail2</label>
                    <input type="file" name="txt_thumbnail_detail2" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail3</label>
                    <input type="file" name="txt_thumbnail_detail3" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail4</label>
                    <input type="file" name="txt_thumbnail_detail4" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Type</label>
                     <select class="form-control" name="txt_type" id="">
             ...
             <input type="submit" class="btn btn-primary mt-2" name="btn-submit" value="Submit">
       ...
       <div class="box_data_new mt-4">
               <!-- Table -->
         <table style="width:100%;" id="example" class="table  table-striped w-100 text-center text-white">
            <thead>
                <tr>
                    <th>Id</th>
                    <th>Title</th>
            ...
            <tr >
                ...
                <td><p class="title"><?=$row['date']?></p></td>
                <td><p class="title"><?=$row['publisher']?></p></td>
                <td><p class="title"><?=$row['title_detail1']?></p></td>
                <td><p class="title"><?=$row['title_detail2']?></p></td>
                
                <td><img width="40px" height="40px" style="border-radius:50px;" src="../upload/<?=$row['thumbnail_card']?>" alt=""></td>
                <td><img width="40px" height="40px" style="border-radius:50px;" src="../upload/<?=$row['thumbnail_detail1']?>" alt=""></td>
                <td><img width="40px" height="40px" style="border-radius:50px;" src="../upload/<?=$row['thumbnail_detail2']?>" alt=""></td>
                <td><img width="40px" height="40px" style="border-radius:50px;" src="../upload/<?=$row['thumbnail_detail3']?>" alt=""></td>
                <td><img width="40px" height="40px" style="border-radius:50px;" src="../upload/<?=$row['thumbnail_detail4']?>" alt=""></td>
                <td><p class="title"><?=$row['type']?></p></td>
                <td class="d-flex">
                     <div class="mr-3"> <button class="btn btn-success" data-toggle="modal" data-target="#ModalUpdate-<?=$row['id']?>">Update</button> </div>
                     <div ><button class="btn btn-danger" data-toggle="modal" data-target="#ModalDelete-<?=$row['id']?>">Delete</button> </div>
                </td>
            </tr>

            <!-- Modal Update Data-->
 <div class="modal fade" id="ModalUpdate-<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                     <label for="">Title</label>
                    <input type="text" name="txt_title" value="<?=$row['title']?>" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Date</label>
                    <input type="date" name="txt_date" value="<?=$row['date']?>" class="form-control" id="">
               </div>
               ...
               <div class="form-group">
                     <label for="">Publisher</label>
                    <input type="text" name="txt_publisher" value="<?=$row['publisher']?>" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Title_detail1</label>
                    <input type="text" name="txt_title_detail1" value="<?=$row['title_detail1']?>" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Title_detail2</label>
                    <input type="text" name="txt_title_detail2" value="<?=$row['title_detail2']?>" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_card</label>
                     <input type="hidden" name="hid_card" value="<?=$row['thumbnail_card']?>">
                    <input type="file" name="txt_thumbnail_card" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail1</label>
                     <input type="hidden" name="hid_detail1" value="<?=$row['thumbnail_detail1']?>">
                    <input type="file" name="txt_thumbnail_detail1" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail2</label>
                     <input type="hidden" name="hid_detail2" value="<?=$row['thumbnail_detail2']?>">
                    <input type="file" name="txt_thumbnail_detail2" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail3</label>
                     <input type="hidden" name="hid_detail3" value="<?=$row['thumbnail_detail3']?>">
                    <input type="file" name="txt_thumbnail_detail3" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Thumbnail_detail4</label>
                     <input type="hidden" name="hid_detail4" value="<?=$row['thumbnail_detail4']?>">
                    <input type="file" name="txt_thumbnail_detail4" class="form-control" id="">
               </div>
               <div class="form-group">
                     <label for="">Type News</label>
                     <select value="<?=$row['type']?>" class="form-control" name="txt_type" id="">
                        <option value="ហរិញ្ញវត្ថុ">ហរិញ្ញវត្ថុ</option>
                        <option value="ចាប់ផ្តើមអាជីវកម្ម">ចាប់ផ្តើមអាជីវកម្ម</option>
                        <option value="អចលនទ្រព្យ">អចលនទ្រព្យ</option>
                        <option value="ភាពជាអ្នកដឹកនាំ">ភាពជាអ្នកដឹកនាំ</option>
             ...
             <button type="button" class="btn mt-2 btn-secondary" data-dismiss="modal">Close</button>
             <input type="submit" class="btn btn-success mt-2" name="btn-update" value="Update">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
             ...
             <button type="button" class="btn mt-2 btn-secondary" data-dismiss="modal">No</button>
             <input type="submit" class="btn btn-danger mt-2" name="btn-delete" value="Yes">
