  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                    ...
                    <input type="text" name="txt_btn_title" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">photo</label>
                    <input type="file" name="txt_photo" class="form-control" id="">
               </div>
      ...
      <div class="container m-auto">
       <table id="example" class="table  table-striped  text-center text-white" style="margin-left:50px; margin-top:35px;">
          <thead>
              <tr>
                 <th>Id</th>
                 <th>Date</th>
          ...
          <tbody>
              ...
              ?>
               ...
               <td><?=$index;?></td>
                   ...
                   <td><?=$row['title']?></td>
                   <td><?=$row['btn_title']?></td>
                   <td><img width="40px" height="40px" style="border-radius:50px;" src="../upload/<?=$row['photo']?>" alt=""></td>
                    <td class="d-flex">
                       <div class="mr-3"> <button class="btn btn-success" data-toggle="modal" data-target="#ModalUpdate-<?=$row['id']?>">Update</button></div> 
                       <button class="btn btn-danger"  data-toggle="modal" data-target="#ModalDelet-<?=$row['id']?>">Delete</button>
                    </td>
               </tr>
               <!-- Modal Update -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                     <label for="">Date</label>
                    <input type="date" value="<?=$row['date']?>" name="txt_date" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Title</label>
                    <input type="text" value="<?=$row['title']?>" name="txt_title" class="form-control" id="">
               </div>

               <div class="form-group">
                     <label for="">Btn-title</label>
                    <input type="text" value="<?=$row['btn_title']?>" name="txt_btn_title" class="form-control" id="">
               </div>
             ...
             <button type="button" class="btn mt-2 btn-secondary" data-dismiss="modal">Close</button>
             <input type="submit" class="btn btn-primary mt-2" name="btn-update" value="Update">
               ...
               <!-- Modal Delete -->
 <div class="modal fade" id="ModalDelet-<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
         <form action="" method="post" enctype="multipart/form-data">
              <p>Do you want to delete?</p>
               <input type="hidden" name="txt_id" value="<?=$row['id']?>" id="">
              
             <button type="button" class="btn mt-2 btn-secondary" data-dismiss="modal">Close</button>
             <input type="submit" class="btn btn-primary mt-2" name="btn-Delete" value="Delete">
